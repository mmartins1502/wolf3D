...
/*   Updated: 2017/08/10 17:59:01 by mmartins         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		ray_init(t_env *e, int x)
{
	...
	e->ray.dir.x = e->play.dir.x + e->play.pl.x * e->ray.cam;
	e->ray.dir.y = e->play.dir.y + e->play.pl.y * e->ray.cam;
...
void			raycasting(t_env *e)
{
	...
	x = -1;
	e->ray.pos.x = e->play.pos.x;
	e->ray.pos.y = e->play.pos.y;
	while (++x < e->width)
	{
		ray_init(e, x);
		ray_cal_step_side(e);
